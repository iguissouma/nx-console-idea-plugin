...
class NxLintConfiguration internal constructor(private val ngProject: NxProject,
                                               private val config: AngularJsonLintOptions,
                                               val name: String? = null) {
  private val myIncludes = AtomicNullableLazyValue.createValue {
    config.files.mapNotNull(Companion::createGlobMatcher).nullize()
  }
  private val myExcludes = NotNullLazyValue.atomicLazy {
    config.exclude.mapNotNull(Companion::createGlobMatcher)
  }
